function Strafkatalog_StrafeErstellen(formular_oeffnen, dom, data, modal_title, strafe_id) {
    if (formular_oeffnen) {
        ...
        $neues_formular.attr("data-werkzeug", "strafe_erstellen").attr("data-liste", "strafkatalog").attr("data-strafe_id", strafe_id);
