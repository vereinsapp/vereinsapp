...
function Schnittstelle_Dom$ZielZu$QuelleZurueck($quelle) {
    if (typeof $quelle !== "undefined" && $quelle.exists()) {
        const $ziel = $("#" + $quelle.attr("data-ziel_id"));
        if (typeof $ziel !== "undefined" && $ziel.exists()) return $ziel;
        else {
            Schnittstelle_LogInDieKonsole("Schnittstelle_Dom$ZielZu$QuelleZurueck: Ziel für #" + $quelle.attr("data-ziel_id") + " nicht gefunden!");
