...
class Mitglieder extends BaseController {
    ...
    public function ajax_mitglied_speichern() { $ajax_antwort[CSRF_NAME] = csrf_hash();
        ...
        if( array_key_exists( 'vorstandschaft_janein', EIGENSCHAFTEN['mitglieder'] ) ) $validation_rules['vorstandschaft_janein'] = [ 'label' => EIGENSCHAFTEN['mitglieder']['vorstandschaft_janein']['beschriftung'], 'rules' => [ 'required', 'in_list['.implode( ', ', array_keys( VORGEGEBENE_WERTE['mitglieder']['vorstandschaft_janein'] ) ).']', ] ];
        if( array_key_exists( 'aktiv_janein', EIGENSCHAFTEN['mitglieder'] ) ) $validation_rules['aktiv_janein'] = [ 'label' => EIGENSCHAFTEN['mitglieder']['aktiv_janein']['beschriftung'], 'rules' => [ 'required', 'in_list['.implode( ', ', array_keys( VORGEGEBENE_WERTE['mitglieder']['aktiv_janein'] ) ).']', ] ];
