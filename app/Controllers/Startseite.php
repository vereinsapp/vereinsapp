...
class Startseite extends BaseController {
    ...
    public function startseite() {
        ...
        $this->viewdata['liste']['anstehende_geburtstage']['element']['beschriftung'] = '<i class="bi bi-'.ICONS['geburtstag'].'"></i> '.VIEWDATA['mitglieder']['element']['beschriftung'];
        ...
        if( array_key_exists( LISTEN['termine']['controller'], CONTROLLERS ) ) {
            ...
            $this->viewdata['liste']['bevorstehende_termine_startseite']['element']['beschriftung'] = '<i class="bi bi-'.ICONS['termine'].'"></i> '.VIEWDATA['termine']['element']['beschriftung'];
        ...
        if( array_key_exists( LISTEN['termine_rueckmeldungen']['controller'], CONTROLLERS ) ) {
            ...
            $this->viewdata['liste']['termine_ausstehende_rueckmeldung']['element']['beschriftung'] = '<i class="bi bi-'.ICONS['termine'].'"></i> '.VIEWDATA['termine']['element']['beschriftung'];
