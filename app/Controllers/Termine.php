...
class Termine extends BaseController {
    ...
    public function termin( $termin_id ) { $termin_id = (int)$termin_id;
        ...
        if( array_key_exists( LISTEN['aufgaben']['controller'], CONTROLLERS ) ) {
            ...
            $this->viewdata['liste']['zugeordnete_aufgaben']['element']['beschriftung'] = '<i class="bi bi-'.SYMBOLE['aufgaben'].'"></i> <span class="eigenschaft" eigenschaft="aufgabe_titel"></span>';
        ...
        if( array_key_exists( LISTEN['notenbank']['controller'], CONTROLLERS ) ) {
            ...
            $this->viewdata['liste']['zugeordnete_setliste']['element']['beschriftung'] = '<span class="eigenschaft text-secondary small" eigenschaft="status"></span> <i class="bi bi-'.SYMBOLE['notenbank'].'"></i> <span class="eigenschaft" eigenschaft="titel_titel_nr"></span> <span class="eigenschaft" eigenschaft="titel_titel"></span>';
            ...
            if( auth()->user()->can( 'notenbank.verwaltung' ) ) {
                ...
                $this->viewdata['liste']['setliste_verwalten']['element']['beschriftung'] = '<i class="bi bi-'.SYMBOLE['notenbank'].'"></i> '.VIEWDATA['notenbank']['element']['beschriftung'];
        ...
        if( auth()->user()->can( 'termine.verwaltung' ) AND auth()->user()->can( 'mitglieder.verwaltung' ) ) {
            ...
            $this->viewdata['liste']['termine_rueckmeldungen_verwalten']['element']['beschriftung'] = '<i class="bi bi-'.SYMBOLE['mitglied'].'"></i> '.VIEWDATA['mitglieder']['element']['beschriftung'];
