...
class Vereinsapp_javascript extends BaseConfig
{
    ...
    public $pfad = array(
        ...
        'js/vereinsapp/dom/Dom_$ZusatzsymbolInitialisiertZurueck.js?v='.VERSION,
        'js/vereinsapp/dom/Dom_$SpacerInitialisiertZurueck.js?v='.VERSION,
        ...
        'js/vereinsapp/liste/Liste_$ListeMetaAktualisieren.js?v='.VERSION,
        ...
        'js/vereinsapp/liste/event/Liste_EventListenBereitstellen.js?v='.VERSION,
        'js/vereinsapp/liste/event/Liste_EventVerknuepfungenBereitstellen.js?v='.VERSION,
        'js/vereinsapp/liste/event/Liste_EventListenLocalstorageSpeichern.js?v='.VERSION,
        'js/vereinsapp/liste/event/Liste_EventVerknuepfungenLocalstorageSpeichern.js?v='.VERSION,
        ...
        'js/vereinsapp/liste/verknuepfungen/Liste_VerknuepfungLoeschen.js?v='.VERSION,
