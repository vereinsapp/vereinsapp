...
class Vereinsapp_javascript extends BaseConfig
{
    ...
    public $pfad = array(
        ...
        'js/vereinsapp/liste/filtern/Liste_$FilternWertInExklusivVerschieben.js?v='.VERSION,
        'js/vereinsapp/liste/filtern/Liste_$FilternWertLoeschen.js?v='.VERSION,
        ...
        'js/vereinsapp/liste/verknuepfungen/Liste_$VerknuepfungenAuswahlmoeglichkeitenAktualisieren.js?v='.VERSION,
