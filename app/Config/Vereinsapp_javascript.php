...
class Vereinsapp_javascript extends BaseConfig
{
    ...
    public $pfad = array(
        ...
        'js/vereinsapp/liste/Liste_Aktualisieren.js?v='.VERSION,
        'js/vereinsapp/liste/Liste_UeberschriftAktualisieren.js?v='.VERSION,
        'js/vereinsapp/liste/Liste_WerkzeugAktualisieren.js?v='.VERSION,
        'js/vereinsapp/liste/Liste_ListenstatistikAktualisieren.js?v='.VERSION,

        'js/vereinsapp/liste/element/Liste_ElementFormularInitialisieren.js?v='.VERSION,
        ...
        'js/vereinsapp/liste/element/Liste_ElementLinkAktualisieren.js?v='.VERSION,
        'js/vereinsapp/liste/element/Liste_ElementZusatzsymbolAktualisieren.js?v='.VERSION,
        'js/vereinsapp/liste/element/Liste_ElementZusatzinfoAktualisieren.js?v='.VERSION,
        'js/vereinsapp/liste/element/Liste_ElementVorschauAktualisieren.js?v='.VERSION,
        'js/vereinsapp/liste/element/Liste_ElementNavigationAktualisieren.js?v='.VERSION,
        ...
        'js/vereinsapp/liste/element/Liste_ElementBeschriftungZurueck.js?v='.VERSION,

        'js/vereinsapp/liste/filtern/Liste_FilternInit.js?v='.VERSION,
        'js/vereinsapp/liste/filtern/Liste_FilternModalOeffnen.js?v='.VERSION,
        'js/vereinsapp/liste/filtern/Liste_FilternAendern.js?v='.VERSION,
        'js/vereinsapp/liste/filtern/Liste_FilternWertInExklusivVerschieben.js?v='.VERSION,
        'js/vereinsapp/liste/filtern/Liste_FilternWertLoeschen.js?v='.VERSION,
        'js/vereinsapp/liste/filtern/Liste_FilternEigenschaftZuruecksetzen.js?v='.VERSION,
        'js/vereinsapp/liste/filtern/Liste_FilternFormularInitialisieren.js?v='.VERSION,
        'js/vereinsapp/liste/filtern/Liste_FilternFormular$EigenschaftAktualisieren.js?v='.VERSION,
        'js/vereinsapp/liste/filtern/Liste_FilternVorgegebenAuswaehlen.js?v='.VERSION,
        ...
        'js/vereinsapp/liste/sortieren/Liste_SortierenModalOeffnen.js?v='.VERSION,
        'js/vereinsapp/liste/sortieren/Liste_SortierenAendern.js?v='.VERSION,
        ...
        'js/vereinsapp/liste/gruppieren/Liste_GruppierenModalOeffnen.js?v='.VERSION,
        'js/vereinsapp/liste/gruppieren/Liste_GruppierenAendern.js?v='.VERSION,
        ...
        'js/vereinsapp/liste/verzeichnis/Liste_DateiAktualisieren.js?v='.VERSION,
