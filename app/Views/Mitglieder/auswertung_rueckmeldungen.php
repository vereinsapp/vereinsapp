<li class="blanko invisible" data-blanko="auswertung" style="list-style: none;">
    ...
    <?php if( array_key_exists( 'collapse', $auswertung ) AND $auswertung['collapse'] ) { ?><div class="row g-0 collapse auswertung_collapse">
        ...
        <div id="<?= $auswertung['instanz']; ?>_ergebnis_0" class="ergebnis liste col-12 text-center text-<?= VERKNUEPFUNGEN['termine_rueckmeldungen']['auswahlmoeglichkeiten'][0]['farbe']; ?> small" data-liste="termine" data-status=0>
            <span class="me-1 blanko invisible" data-blanko="element"><span class="eigenschaft" data-eigenschaft="start"></span> <span class="eigenschaft" data-eigenschaft="titel"></span><?= VERKNUEPFUNGEN['termine_rueckmeldungen']['auswahlmoeglichkeiten'][0]['aktiv']; ?></span>
        </div>
    </div><?php } ?>
</li>