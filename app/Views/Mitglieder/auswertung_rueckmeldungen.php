<li class="blanko invisible" blanko="auswertung" auswertungen="termine_rueckmeldungen" instanz="<?= $auswertung['instanz']; ?>" liste="<?= $auswertungen['liste']; ?>" style="list-style: none;">
    ...
    <?php if( array_key_exists( 'collapse', $auswertung ) AND $auswertung['collapse'] ) { ?><div class="row g-0 collapse auswertung_collapse">
        <ul id="<?= $auswertung['instanz']; ?>_ergebnis_1" class="ergebnis liste col-6 text-center text-<?= VERKNUEPFUNGEN['termine_rueckmeldungen']['status_erlaubt'][1]['farbe']; ?>" liste="termine_rueckmeldungen" style="list-style-type: none;" status=1>
            <li class="blanko invisible" blanko="element" liste="termine_rueckmeldungen" instanz="<?= $auswertung['instanz']; ?>_ergebnis_1"><span class="eigenschaft" eigenschaft="termin_start"></span> <span class="eigenschaft" eigenschaft="termin_titel"></span><span class="zusatzsymbol ms-2" zusatzsymbol="bemerkung"></span></li>
        </ul>
        <ul id="<?= $auswertung['instanz']; ?>_ergebnis_2" class="ergebnis liste col-6 text-center text-<?= VERKNUEPFUNGEN['termine_rueckmeldungen']['status_erlaubt'][2]['farbe']; ?>" liste="termine_rueckmeldungen" style="list-style-type: none;" status=2>
            <li class="blanko invisible" blanko="element" liste="termine_rueckmeldungen" instanz="<?= $auswertung['instanz']; ?>_ergebnis_2"><span class="eigenschaft" eigenschaft="termin_start"></span> <span class="eigenschaft" eigenschaft="termin_titel"></span><span class="zusatzsymbol ms-2" zusatzsymbol="bemerkung"></span></li>
        </ul>
        <div id="<?= $auswertung['instanz']; ?>_ergebnis_0" class="ergebnis liste col-12 text-center text-<?= VERKNUEPFUNGEN['termine_rueckmeldungen']['status_erlaubt'][0]['farbe']; ?> small" liste="termine" status=0>
            <span class="me-1 blanko invisible" blanko="element" liste="termine" instanz="<?= $auswertung['instanz']; ?>_ergebnis_0"><span class="eigenschaft" eigenschaft="start"></span> <span class="eigenschaft" eigenschaft="titel"></span><?= VERKNUEPFUNGEN['termine_rueckmeldungen']['status_erlaubt'][0]['aktiv']; ?></span>
        </div>
    </div><?php } ?>
</li>