<li class="blanko auswertung invisible" style="list-style: none;">
    ...
    <div class="row g-0 collapse auswertung_collapse">
        <ul id="<?= $auswertungen['id']; ?>_ergebnis_1" class="ergebnis liste col-6 text-center text-<?= VERKNUEPFUNGEN['termine_rueckmeldungen']['auswahlmoeglichkeiten'][1]['farbe']; ?>" data-liste="termine" style="list-style-type: none;" data-status=1>
            <li class="blanko element invisible"><span class="eigenschaft" data-eigenschaft="start"></span> <span class="eigenschaft" data-eigenschaft="titel"></span><span class="zusatzsymbol ms-2" data-zusatzsymbol="bemerkung"></span></li>
        </ul>
        <ul id="<?= $auswertungen['id']; ?>_ergebnis_2" class="ergebnis liste col-6 text-center text-<?= VERKNUEPFUNGEN['termine_rueckmeldungen']['auswahlmoeglichkeiten'][2]['farbe']; ?>" data-liste="termine" style="list-style-type: none;" data-status=2>
            <li class="blanko element invisible"><span class="eigenschaft" data-eigenschaft="start"></span> <span class="eigenschaft" data-eigenschaft="titel"></span><span class="zusatzsymbol ms-2" data-zusatzsymbol="bemerkung"></span></li>
        </ul>
        <div id="<?= $auswertungen['id']; ?>_ergebnis_0" class="ergebnis liste col-12 text-center text-secondary small" data-liste="termine" data-status=0>
