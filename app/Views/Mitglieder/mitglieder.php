...
<?php if( array_key_exists( LISTEN['termine_anwesenheiten']['controller'], CONTROLLERS ) ) echo
...
<?php if( array_key_exists( 'termine.verwaltung', VERFUEGBARE_RECHTE ) AND auth()->user()->can( 'termine.verwaltung' ) ) echo
