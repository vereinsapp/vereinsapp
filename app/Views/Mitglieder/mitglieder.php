...
<?= view( 'Templates/Liste/liste', array( 'liste' => $liste['alle_mitglieder'], 'typ' => 'kacheln', 'element' =>
    view( 'Templates/Liste/element_kacheln', array( 'liste' => $liste['alle_mitglieder'] ) ) ) ); ?>
