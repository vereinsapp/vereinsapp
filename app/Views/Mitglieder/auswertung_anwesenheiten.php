<li class="blanko invisible" data-blanko="auswertung" data-auswertungen="termine_anwesenheiten" data-instanz="<?= $auswertung['instanz']; ?>" data-liste="<?= $auswertungen['liste']; ?>" style="list-style: none;">
    ...
    <?php if( array_key_exists( 'collapse', $auswertung ) AND $auswertung['collapse'] ) { ?><div class="row g-0 collapse auswertung_collapse">
        ...
        <ul id="<?= $auswertung['instanz']; ?>_ergebnis_0" class="ergebnis liste col-6 text-center text-<?= VERKNUEPFUNGEN['termine_anwesenheiten']['status_erlaubt'][0]['farbe']; ?>" data-liste="termine" style="list-style-type: none;" data-status=0>
            <li class="blanko invisible" data-blanko="element" data-liste="termine" data-instanz="<?= $auswertung['instanz']; ?>_ergebnis_0"><span class="eigenschaft" data-eigenschaft="start"></span> <span class="eigenschaft" data-eigenschaft="titel"></span></li>
        </ul>
    </div><?php } ?>
</li>