<div class="blanko invisible" blanko="auswertung" verknuepfungen="termine_anwesenheiten" instanz="<?= $auswertung['instanz']; ?>" liste="<?= $auswertungen['liste']; ?>">
    ...
    <?php if( array_key_exists( 'collapse', $auswertung ) AND $auswertung['collapse'] ) { ?><div class="row g-0 collapse">
        <div id="<?= $auswertung['instanz']; ?>_ergebnis_1" class="ergebnis liste col-6 text-start text-<?= VERKNUEPFUNGEN['termine_anwesenheiten']['status_erlaubt'][1]['farbe']; ?>" liste="termine" status=1>
            <div class="elemente"><div class="blanko invisible" blanko="element" liste="termine" instanz="<?= $auswertung['instanz']; ?>_ergebnis_1"><span class="element_beschriftung"></span><?= view( 'Templates/Liste/verknuepfung_bemerkung', array( 'verknuepfungen' => "termine_anwesenheiten", ) ); ?></div></div>
        </div>
