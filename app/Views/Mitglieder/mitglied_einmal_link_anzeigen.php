...
?> werkzeug" werkzeug="einmal_link_anzeigen"><span class="beschriftung"><i class="bi bi-<?= SYMBOLE[ WERKZEUGE['einmal_link_anzeigen']['symbol'] ]['bootstrap']; ?>"></i>  <?= WERKZEUGE['einmal_link_anzeigen']['beschriftung']['beschriftung']; ?></span></button></div>
