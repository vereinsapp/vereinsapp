<div class="formular btn-group btn-group-sm d-flex stretched-link-unwirksam invisible" role="group" data-liste="rueckmeldungen">
    ...
    <button type="button" class="btn btn_rueckmeldung_detaillieren formular_oeffnen btn-outline-success flex-fill" data-liste="rueckmeldungen" data-title="Bemerkung machen"><i class="bi bi-<?= SYMBOLE['bemerkung']['bootstrap']; ?>"></i></button>
