...
<div class="container mb-3 element" liste="termine" termin_id="<?= $termin_id; ?>" mitglied_id="<?= ICH_ID; ?>">
<?= view( 'Templates/Liste/element_navigation', array( 'element_navigation' => $element_navigation ) ); ?>
    <div class="h5 beschriftung text-center"><span class="eigenschaft" eigenschaft="titel"></span></div>
    <div class="row g-0 my-1">
        <div class="col-5 text-center text-nowrap">
            <div><i class="bi bi-<?= SYMBOLE["zeitraum"]["bootstrap"]; ?>"></i></div>
            <div class="eigenschaft" eigenschaft="start"></div>
        ...
        <div class="col-2 text-center text-nowrap"><span class="zusatzsymbol" zusatzsymbol="kategorie"></span></div>
        <div class="col-5 text-center text-nowrap">
