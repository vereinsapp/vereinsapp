<li class="blanko auswertung invisible" style="list-style: none;">
    ...
    <?php if( array_key_exists( 'collapse', $auswertung ) AND $auswertung['collapse'] ) { ?><div class="row g-0 collapse auswertung_collapse">
        ...
        <div id="<?= $auswertung['id']; ?>_ergebnis_0" class="ergebnis liste col-12 text-center text-secondary small" data-liste="mitglieder" data-status=0>
            <span class="blanko element invisible"><span class="eigenschaft" data-eigenschaft="vorname"></span> <span class="eigenschaft" data-eigenschaft="nachname"></span><i class="bi bi-<?= SYMBOLE['ohne_rueckmeldung']['bootstrap']; ?> me-1"></i></span>
        </div>
    </div><?php } ?>
</li>