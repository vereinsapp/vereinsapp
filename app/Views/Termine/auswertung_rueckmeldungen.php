<li class="blanko invisible" data-blanko="auswertung" style="list-style: none;">
    ...
    <?php if( array_key_exists( 'collapse', $auswertung ) AND $auswertung['collapse'] ) { ?><div class="row g-0 collapse auswertung_collapse">
        <ul id="<?= $auswertung['instanz']; ?>_ergebnis_1" class="ergebnis liste col-6 text-center text-<?= VERKNUEPFUNGEN['termine_rueckmeldungen']['status_erlaubt'][1]['farbe']; ?>" data-liste="termine_rueckmeldungen" style="list-style-type: none;" data-status=1>
            <li class="blanko invisible" data-blanko="element"><span class="eigenschaft" data-eigenschaft="mitglied_vorname"></span> <span class="eigenschaft" data-eigenschaft="mitglied_nachname"></span><span class="zusatzsymbol ms-2" data-zusatzsymbol="bemerkung"></span></li>
        </ul>
        ...
        <div id="<?= $auswertung['instanz']; ?>_ergebnis_0" class="ergebnis liste col-12 text-center text-<?= VERKNUEPFUNGEN['termine_rueckmeldungen']['status_erlaubt'][0]['farbe']; ?> small" data-liste="mitglieder" data-status=0>
            <span class="me-1 blanko invisible" data-blanko="element"><span class="eigenschaft" data-eigenschaft="vorname"></span> <span class="eigenschaft" data-eigenschaft="nachname"></span><?= VERKNUEPFUNGEN['termine_rueckmeldungen']['status_erlaubt'][0]['aktiv']; ?></span>
        </div>
    </div><?php } ?>
</li>