<div class="blanko invisible" blanko="auswertung" verknuepfungen="termine_rueckmeldungen" instanz="<?= $auswertung['instanz']; ?>" liste="<?= $auswertungen['liste']; ?>">
    ...
    <?php if( array_key_exists( 'collapse', $auswertung ) AND $auswertung['collapse'] ) { ?><div class="row g-0 collapse">
        <div id="<?= $auswertung['instanz']; ?>_ergebnis_1" class="ergebnis liste col-6 text-center text-<?= VERKNUEPFUNGEN['termine_rueckmeldungen']['status_erlaubt'][1]['farbe']; ?>" liste="mitglieder" status=1>
            <div class="elemente"><div class="blanko invisible" blanko="element" liste="mitglieder" instanz="<?= $auswertung['instanz']; ?>_ergebnis_1"><span class="element_beschriftung"></span><span class="zusatzsymbole" zusatzsymbole='<?= json_encode( array( 'bemerkung' ), JSON_UNESCAPED_UNICODE ) ?>'></span></div></div>
        </div>
        <div id="<?= $auswertung['instanz']; ?>_ergebnis_2" class="ergebnis liste col-6 text-center text-<?= VERKNUEPFUNGEN['termine_rueckmeldungen']['status_erlaubt'][2]['farbe']; ?>" liste="mitglieder" status=2>
            <div class="elemente"><div class="blanko invisible" blanko="element" liste="mitglieder" instanz="<?= $auswertung['instanz']; ?>_ergebnis_2"><span class="element_beschriftung"></span><span class="zusatzsymbole" zusatzsymbole='<?= json_encode( array( 'bemerkung' ), JSON_UNESCAPED_UNICODE ) ?>'></span></div></div>
        </div>
