<li class="blanko auswertung invisible" style="list-style: none;">
    ...
    <div class="row g-0 collapse auswertung_collapse">
        <ul id="<?= $auswertungen['id']; ?>_ergebnis_1" class="ergebnis liste col-6 text-center text-<?= TERMINE_RUECKMELDUNG_AUSWAHLMOEGLICHKEITEN[1]['farbe']; ?>" data-liste="mitglieder" style="list-style-type: none;" data-status=1>
        ...
        <ul id="<?= $auswertungen['id']; ?>_ergebnis_2" class="ergebnis liste col-6 text-center text-<?= TERMINE_RUECKMELDUNG_AUSWAHLMOEGLICHKEITEN[2]['farbe']; ?>" data-liste="mitglieder" style="list-style-type: none;" data-status=2>
            <li class="blanko element invisible"><span class="eigenschaft" data-eigenschaft="vorname"></span> <span class="eigenschaft" data-eigenschaft="nachname"></span><span class="zusatzsymbol ms-2" data-zusatzsymbol="bemerkung"></span></li>
        </ul>
