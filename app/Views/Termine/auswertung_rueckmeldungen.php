<li class="blanko invisible" data-blanko="auswertung" data-auswertungen="termine_rueckmeldungen" data-instanz="<?= $auswertung['instanz']; ?>" data-liste="<?= $auswertungen['liste']; ?>" style="list-style: none;">
    <div class="row g-0"<?php if( array_key_exists( 'collapse', $auswertung ) AND $auswertung['collapse'] ) { ?> data-bs-toggle="collapse" role="button"<?php } ?>>
        ...
        <div class="col-10 text-center">
            ...
            <?php if( array_key_exists( 'progress', $auswertung ) AND $auswertung['progress'] ) { ?><div class="progress-stacked auswertung_progress">
                <div class="progress ergebnis_anzahl" role="progressbar" data-status=1><div class="progress-bar bg-<?= VERKNUEPFUNGEN['termine_rueckmeldungen']['status_erlaubt'][1]['farbe']; ?>"></div></div>
                <div class="progress ergebnis_anzahl" role="progressbar" data-status=0><div class="progress-bar bg-transparent"></div></div>
                <div class="progress ergebnis_anzahl" role="progressbar" data-status=2><div class="progress-bar bg-<?= VERKNUEPFUNGEN['termine_rueckmeldungen']['status_erlaubt'][2]['farbe']; ?>"></div></div>
            </div><?php } ?>
        </div>
        <div class="ergebnis_anzahl col-1 h5 float-end text-end text-<?= VERKNUEPFUNGEN['termine_rueckmeldungen']['status_erlaubt'][2]['farbe']; ?>" data-status=2></div>
    </div>
    <?php if( array_key_exists( 'collapse', $auswertung ) AND $auswertung['collapse'] ) { ?><div class="row g-0 collapse auswertung_collapse">
        ...
        <ul id="<?= $auswertung['instanz']; ?>_ergebnis_2" class="ergebnis liste col-6 text-center text-<?= VERKNUEPFUNGEN['termine_rueckmeldungen']['status_erlaubt'][2]['farbe']; ?>" data-liste="termine_rueckmeldungen" style="list-style-type: none;" data-status=2>
            <li class="blanko invisible" data-blanko="element" data-liste="termine_rueckmeldungen" data-instanz="<?= $auswertung['instanz']; ?>_ergebnis_2"><span class="eigenschaft" data-eigenschaft="mitglied_vorname"></span> <span class="eigenschaft" data-eigenschaft="mitglied_nachname"></span><span class="zusatzsymbol ms-2" data-zusatzsymbol="bemerkung"></span></li>
        </ul>
        <div id="<?= $auswertung['instanz']; ?>_ergebnis_0" class="ergebnis liste col-12 text-center text-<?= VERKNUEPFUNGEN['termine_rueckmeldungen']['status_erlaubt'][0]['farbe']; ?> small" data-liste="mitglieder" data-status=0>
            <span class="me-1 blanko invisible" data-blanko="element" data-liste="mitglieder" data-instanz="<?= $auswertung['instanz']; ?>_ergebnis_0"><span class="eigenschaft" data-eigenschaft="vorname"></span> <span class="eigenschaft" data-eigenschaft="nachname"></span><?= VERKNUEPFUNGEN['termine_rueckmeldungen']['status_erlaubt'][0]['aktiv']; ?></span>
        </div>
    </div><?php } ?>
</li>