<div class="input-group sortieren_eigenschaft">
    ...
    <label class="btn btn-outline-primary btn-lg" for="sortieren_richtung_asc"><span class="beschriftung"><i class="bi bi-<?= ICONS['asc']; ?>"></i></span></label>
    <input type="radio" class="btn-check sortieren_richtung" name="sortieren_richtung" id="sortieren_richtung_desc" value="<?= SORT_DESC; ?>">
    <label class="btn btn-outline-primary btn-lg" for="sortieren_richtung_desc"><span class="beschriftung"><i class="bi bi-<?= ICONS['desc']; ?>"></i></span></label>
    ...
    ?> werkzeug" werkzeug="sortieren_eigenschaft_zuruecksetzen"><span class="beschriftung"><i class="bi bi-<?= ICONS[ WERKZEUGE['sortieren_eigenschaft_zuruecksetzen']['symbol'] ]; ?>"></i></span></button>
</div>