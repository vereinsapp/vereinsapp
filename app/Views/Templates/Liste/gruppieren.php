<div class="input-group gruppieren_eigenschaft">
    ...
    ?> werkzeug" data-werkzeug="gruppieren_eigenschaft_zuruecksetzen"><span class="beschriftung"><i class="bi bi-<?= SYMBOLE[ WERKZEUGE['gruppieren_eigenschaft_zuruecksetzen']['symbol'] ]['bootstrap']; ?>"></i></span></button>
</div>