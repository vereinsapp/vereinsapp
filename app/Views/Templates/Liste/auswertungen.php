<div id="<?= $auswertungen['instanz']; ?>" class="auswertungen w-100<?php
    ...
    if( array_key_exists( 'werkzeuge_auswertungen', $auswertungen ) AND is_array( $auswertungen['werkzeuge_auswertungen'] ) AND count( $auswertungen['werkzeuge_auswertungen'] ) > 0 ) { ?> werkzeuge='<?= json_encode( array_reverse( $auswertungen['werkzeuge_auswertungen'] ), JSON_UNESCAPED_UNICODE ); ?>'<?php }
    ?>>
    <div class="meta w-100"></div>
