<div class="verknuepfungen_auswahlmoeglichkeiten" data-verknuepfungen="<?= $verknuepfungen ?>">
    <div class="verknuepfung_moeglich stretched-link-unwirksam invisible">
        <div class="btn-group btn-group-sm d-flex" role="group">
            <button type="button" class="btn btn_verknuepfung_erstellen btn-outline-<?= VERKNUEPFUNGEN[ $verknuepfungen ]['status_erlaubt'][1]['farbe']; ?> w-25 flex-fill" data-status="1">
                <span class="beschriftung"><?= VERKNUEPFUNGEN[ $verknuepfungen ]['status_erlaubt'][1]['aktiv']; ?></span>
            </button>
            <button type="button" class="btn btn_element_bemerkung_aendern formular_oeffnen btn-outline-primary flex-fill" data-liste="<?= $verknuepfungen ?>">
                <span class="beschriftung"><i class="bi bi-<?= SYMBOLE['bemerkung']['bootstrap']; ?>"></i></span>
            </button>
            <button type="button" class="btn btn_verknuepfung_erstellen btn-outline-<?= VERKNUEPFUNGEN[ $verknuepfungen ]['status_erlaubt'][2]['farbe']; ?> w-25 flex-fill" data-status="2">
