<div class="verknuepfungen" data-verknuepfungen="<?= $verknuepfungen ?>">
    <div class="verknuepfung_moeglich stretched-link-unwirksam invisible">
        <div class="btn-group btn-group-sm d-flex" role="group">
            <button type="button" class="btn btn-outline-<?= VERKNUEPFUNGEN[ $verknuepfungen ]['status_erlaubt'][1]['farbe']; ?> w-25 flex-fill werkzeug" data-werkzeug="<?= LISTEN[ $verknuepfungen ]['element']?>_erstellen" data-status="1">
            ...
            ?> flex-fill werkzeug" data-werkzeug="bemerkung_aendern" data-liste="<?= $verknuepfungen ?>">
                <span class="beschriftung"><i class="bi bi-<?= SYMBOLE['bemerkung']['bootstrap']; ?>"></i></span>
            </button>
            <button type="button" class="btn btn-outline-<?= VERKNUEPFUNGEN[ $verknuepfungen ]['status_erlaubt'][2]['farbe']; ?> w-25 flex-fill werkzeug" data-werkzeug="<?= LISTEN[ $verknuepfungen ]['element']?>_erstellen" data-status="2">
