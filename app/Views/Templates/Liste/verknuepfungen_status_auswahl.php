...
?>>
    <div class="verknuepfung_moeglich stretched-link-unwirksam invisible">
        <div class="btn-group btn-group-sm d-flex" role="group">
            <button type="button" class="btn btn_verknuepfung_erstellen btn-outline-<?= VERKNUEPFUNGEN[ $verknuepfungen['verknuepfungen'] ]['status_erlaubt'][1]['farbe']; ?> w-25 flex-fill" data-status="1">
                <span class="beschriftung"><?= VERKNUEPFUNGEN[ $verknuepfungen['verknuepfungen'] ]['status_erlaubt'][1]['aktiv']; ?></span>
            </button>
            ...
            <button type="button" class="btn btn_verknuepfung_erstellen btn-outline-<?= VERKNUEPFUNGEN[ $verknuepfungen['verknuepfungen'] ]['status_erlaubt'][2]['farbe']; ?> w-25 flex-fill" data-status="2">
                <span class="beschriftung"><?= VERKNUEPFUNGEN[ $verknuepfungen['verknuepfungen'] ]['status_erlaubt'][2]['aktiv']; ?></span>
            </button>
        </div>
    </div>
