<div class="verknuepfungen_auswahlmoeglichkeiten" data-verknuepfungen="<?= $verknuepfungen ?>">
    <div class="verknuepfung_moeglich stretched-link-unwirksam invisible">
        <div class="btn-group btn-group-sm d-flex" role="group">
            <button type="button" class="btn btn_verknuepfung_erstellen<?php
            if( VERKNUEPFUNGEN[ $verknuepfungen ]['bestaetigung_einfordern'] === TRUE ) echo ' bestaetigung_einfordern';
            ?> btn-outline-<?= VERKNUEPFUNGEN[ $verknuepfungen ]['status_erlaubt'][1]['farbe']; ?> w-25 flex-fill" data-status="1">
            ...
            <button type="button" class="btn btn_verknuepfung_erstellen<?php
            if( VERKNUEPFUNGEN[ $verknuepfungen ]['bestaetigung_einfordern'] === TRUE ) echo ' bestaetigung_einfordern';
            ?> btn-outline-<?= VERKNUEPFUNGEN[ $verknuepfungen ]['status_erlaubt'][2]['farbe']; ?> w-25 flex-fill" data-status="2">
