...
<div class="filtern_eigenschaften">
    ...
    <div class="input-group mb-1 blanko invisible" data-blanko="filtern_eigenschaft" data-typ="zahl">
        ...
        ?> werkzeug" data-werkzeug="filtern_eigenschaft_zuruecksetzen"><span class="beschriftung"><i class="bi bi-<?= SYMBOLE[ WERKZEUGE['filtern_eigenschaft_zuruecksetzen']['symbol'] ]['bootstrap']; ?>"></i></span></button>
    </div>
    ...
    <div class="card sichtbar mb-1 blanko invisible" data-blanko="filtern_eigenschaft" data-typ="janein">
        <div class="card-body filtern_werte p-2">
                ...
                <div class="btn-group btn-group-sm me-1 mb-1 blanko invisible" data-blanko="filtern_wert" role="group">
                    ...
                    ?> btn-sm werkzeug" data-werkzeug="filtern_wert_inklusiv_exklusiv"><span class="beschriftung"><i class="bi bi-<?= SYMBOLE[ WERKZEUGE['filtern_wert_inklusiv_exklusiv']['symbol'] ]['bootstrap']; ?>"></i></span></button>
                    <button type="button" class="btn btn-outline-<?php
                    if( array_key_exists('farbe', WERKZEUGE['filtern_wert_loeschen']) ) echo WERKZEUGE['filtern_wert_loeschen']['farbe']; else echo "primary";
                    ?> btn-sm werkzeug" data-werkzeug="filtern_wert_loeschen"><span class="beschriftung"><i class="bi bi-<?= SYMBOLE[ WERKZEUGE['filtern_wert_loeschen']['symbol'] ]['bootstrap']; ?>"></i></span></button>
                </div>
