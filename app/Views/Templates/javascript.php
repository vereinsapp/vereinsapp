...
const AUFGABEN_RUECKMELDUNG_AUSWAHLMOEGLICHKEITEN = <?= json_encode( AUFGABEN_RUECKMELDUNG_AUSWAHLMOEGLICHKEITEN ) ?>;

const TERMINE_KATEGORIE_FILTERN_MITGLIEDER = <?= json_encode( TERMINE_KATEGORIE_FILTERN_MITGLIEDER ) ?>;
const TERMINE_RUECKMELDUNG_AUSWAHLMOEGLICHKEITEN = <?= json_encode( TERMINE_RUECKMELDUNG_AUSWAHLMOEGLICHKEITEN ) ?>;
