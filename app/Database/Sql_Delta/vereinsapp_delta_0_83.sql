...
ALTER TABLE `vereinsapp_strafkatalog_zugewiesene_strafen` ADD PRIMARY KEY (`id`), ADD KEY `strafe_id` (`strafe_id`), ADD KEY `mitglied_id` (`mitglied_id`);
...
ALTER TABLE `vereinsapp_strafkatalog_zugewiesene_strafen` MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;
